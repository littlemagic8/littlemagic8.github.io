...
检查路径：**头像 → Settings → Account / Billing**，或回到首页看是否还写 Free plan。

到账后应显示 **Pro**。如果还显示 Free，先退出再登录（Claude 常有缓存）。
...
>
> 同类教程：[SuperGrok](https://littlemagic8.github.io/2026/08/14/how-to-sub-supergrok/) · [ChatGPT Plus](https://littlemagic8.github.io/2026/08/16/how-to-sub-gptplus/) · [X Premium](https://littlemagic8.github.io/2026/08/16/how-to-sub-x/) · [X Premium+](https://littlemagic8.github.io/2026/08/16/how-to-sub-x-premium-plus/)
